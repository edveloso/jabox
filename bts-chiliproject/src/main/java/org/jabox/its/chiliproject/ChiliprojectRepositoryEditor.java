...
public class ChiliprojectRepositoryEditor extends Panel {
	private static final long serialVersionUID = 3000405193458816252L;

	public ChiliprojectRepositoryEditor(final String id, final IModel<Server> model) {
		...
		add(url.add(new UrlValidator()).add(
				new ChiliprojectLoginValidator(url, username, password))
				.setRequired(true));
