...
public class JaboxFeedbackPanel extends Panel implements IFeedback {
    /**
     * List for messages.
     */
    private final class MessageListView extends ListView<FeedbackMessage> {
        ...
        protected void populateItem(
                final ListItem<FeedbackMessage> listItem) {
     ...
     * @see org.apache.wicket.Component#Component(String)
     */
    public JaboxFeedbackPanel(final String id) {
        this(id, null);
    }
     ...
     */
    public final JaboxFeedbackPanel setFilter(
            final IFeedbackMessageFilter filter) {
     ...
     * @return FeedbackPanel this.
     */
    public final JaboxFeedbackPanel setMaxMessages(final int maxMessages) {
     ...
     * @return FeedbackPanel this.
     */
    public final JaboxFeedbackPanel setSortingComparator(
            final Comparator<FeedbackMessage> sortingComparator) {
     ...
     * <code>span</code> tags. By default a {@link Label} is used. Note that the
     * created component is expected to respect feedback panel's
    ...
    protected Component newMessageDisplayComponent(final String id,
        ...
        label.setEscapeModelStrings(JaboxFeedbackPanel.this
