...
import org.jabox.webapp.borders.ContainersBorder;

public abstract class BaseContainersPage extends WebPage {
    ...
    public void renderHead(final IHeaderResponse response) {
        ...
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseContainersPage.class, "js/widgets.js"));
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseContainersPage.class, "js/jquery.js"));
    }

    private Border border;

    public BaseContainersPage() {
    }

    public BaseContainersPage add(final Component child) {
        // Add children of the page to the page's border component
        if (border == null) {
            // Create border and add it to the page
            border = new ContainersBorder();
            super.add(border);
        }
        border.add(child);
        return this;
