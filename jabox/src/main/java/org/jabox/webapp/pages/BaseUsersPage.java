...
import org.jabox.webapp.borders.UsersBorder;

public abstract class BaseUsersPage extends WebPage {
    ...
    public void renderHead(final IHeaderResponse response) {
        ...
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseUsersPage.class, "js/widgets.js"));
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseUsersPage.class, "js/jquery.js"));
    }

    private Border border;

    public BaseUsersPage() {
    }
