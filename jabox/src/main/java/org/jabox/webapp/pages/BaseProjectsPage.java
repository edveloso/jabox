...
import org.jabox.webapp.borders.ProjectsBorder;

public abstract class BaseProjectsPage extends WebPage {
    ...
    public void renderHead(final IHeaderResponse response) {
        ...
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseProjectsPage.class, "js/widgets.js"));
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseProjectsPage.class, "js/jquery.js"));
    }

    private Border border;

    public BaseProjectsPage() {
    }

    public BaseProjectsPage add(final Component child) {
        // Add children of the page to the page's border component
        if (border == null) {
            // Create border and add it to the page
            border = new ProjectsBorder();
            super.add(border);
        }
        border.add(child);
        return this;
