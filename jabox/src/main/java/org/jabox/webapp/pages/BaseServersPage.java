...
import org.jabox.webapp.borders.ServersBorder;

public abstract class BaseServersPage extends WebPage {
    ...
    public void renderHead(final IHeaderResponse response) {
        ...
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseServersPage.class, "js/widgets.js"));
        response
            .renderJavaScriptReference(new JavaScriptResourceReference(
                BaseServersPage.class, "js/jquery.js"));
    }

    private Border border;

    public BaseServersPage() {
    }

    public BaseServersPage add(final Component child) {
        // Add children of the page to the page's border component
        if (border == null) {
            // Create border and add it to the page
            border = new ServersBorder();
            super.add(border);
        }
        border.add(child);
        return this;
